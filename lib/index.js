...
(this, function () {
    ...
    Queue.prototype.add = function (promiseGenerator) {
        return this._genericAdd(promiseGenerator, 'push');
    };
    ...
    Queue.prototype.addNow = function (promiseGenerator) {
        return this._genericAdd(promiseGenerator, 'unshift');
    };
     ...
     * @private
     */
    Queue.prototype._genericAdd = function (promiseGenerator, type) {
        var self = this;
